...
% use the three commands starting with mathptmx instead of
%\usepackage{times}
% when you need math in your abstract
\usepackage{mathptmx}
\usepackage{helvet}%[scaled=0.92]{helvet}
\usepackage{courier}
% but you could better use mathtime, if you have the (commercial) math fonts
%\usepackage{mathtime}
